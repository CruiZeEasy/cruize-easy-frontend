...
// import { z } from "zod";
// import { RentTypeToggle } from "@/components/dashboard/listings/RentTypeDisplay";
  ...
  return (
    <>
          ...
          <section className="grid lg:grid-cols-2 gap-x-8">
            ...
            <div className="space-y-6">
              <div className="space-y-4 bg-white md:p-4 rounded-[20px]">
                ...
                <span className="font-gilroy-bold">{vehicleName}</span>
              </div>
      ...
      <PageTransitionSpinner
        isVisible={isNavigating || bookingMutation.isPending}
      />
    </>
  );
}
