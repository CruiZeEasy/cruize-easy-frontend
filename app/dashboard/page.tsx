...
export default function UserDashboard() {
  const { data: user } = useCurrentUser();
  const { open: openFilter } = useFilterModal();
  const { isOpen: isCampaignOpen, close: closeCampaign } = useCampaignModal();
    ...
    <>
      <div className="pb-28 lg:pb-0 min-w-0">
        ...
        <div className="p-4 md:p-0 md:px-12 min-w-0">
          ...
          <div className="mt-4 md:mt-6 lg:grid lg:grid-cols-5 gap-x-8 md:h-[calc(100vh-280px)]">
            <div className="md:col-span-2 min-w-0 md:overflow-y-auto md:pr-4">
              <WalletSection />
              <TopBrands />
              <Notifications />
