...
//       <div className="flex flex-col sm:items-center sm:text-center space-y-6 sm:mb-12">
//         <h2 className="text-[18px]  sm:text-4xl font-gilroy-bold">
//           Popular Cars
//         </h2>
//         <p className=" text-neutral-600 font-gilroy-medium hidden sm:block">
//           Choose from our selection of premium vehicles for your next adventure.
//         </p>
//       </div>

//       <div className="grid gap-8">
//         <div className="bg-white border-[#e4e4e4] shadow-md p-4 rounded-lg">
  ...
  return (
    <section className="container">
      <div className="flex flex-col lg:items-center lg:text-center space-y-6 lg:mb-12">
        <h2 className="text-[18px] lg:text-4xl font-gilroy-bold">
          Popular Cars
        </h2>
  ...
  "
      >
        {cars.map((car) => (
          <div
            key={car.id}
            className="bg-white border-[#e4e4e4] shadow-md p-4 rounded-lg flex-shrink-0"
          >
            <span className="flex justify-end">
              <button className="transition duration-20 hover:scale-[1.02] active:scale-95 cursor-pointer mb-4 sm:mb-0">
                <Image
            ...
            <div className="flex justify-center mb-2">
              <Image src={car.src} width={250} height={100} alt="Car Image" />
            </div>
